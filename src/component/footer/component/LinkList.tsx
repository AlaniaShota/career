...
import facebook from '../../../assets/footerImg/Social media icons.svg'
import instagram from '../../../assets/footerImg/Social media icons (1).svg'
import twitter from '../../../assets/footerImg/Group.svg'
import youtube from '../../../assets/footerImg/Social media icons (2).svg' 
import linkedIn from '../../../assets/footerImg/Social media icons (3).svg'
